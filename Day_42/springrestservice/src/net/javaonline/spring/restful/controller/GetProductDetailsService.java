...
public class GetProductDetailsService {
	...
	@RequestMapping(value = "/getProductss", produces = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody List<ProductDetails> getProductMethod1()  // @RequestParam(value="itemcode",
																								// defaultValue="1"
	// String itemcode
	{
		// GetProductDetailsDAO pdDao=new GetProductDetailsDAO();
		System.out.println("detailks");
	...
	public ResponseEntity<ProductDetails> addProductMethod(@RequestBody ProductDetails pdetails,
			UriComponentsBuilder ucBuilder) throws ClassNotFoundException, SQLException {
